...
export const crearUsuarioValidations = [
  ...
  body('nombre_usuario')
    ...
    .isEmail()
    .withMessage(
      'El nombre de usuario debe tener formato de correo electrónico'
    ), // cambio solicitado por el profe
...
export const listarUsuariosValidations = [
  ...
  query('tipoUsuario')
    ...
    .isIn(['cliente', 'empleado', 'administrador'])
    .withMessage(
      'tipoUsuario debe ser uno de los siguientes: cliente, empleado, administrador'
    ),
];
